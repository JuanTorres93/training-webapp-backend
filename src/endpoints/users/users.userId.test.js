  ...
  describe("put requests", () => {
    ...
    describe("happy path", () => {
      ...
      it("returns updated user", () => {
        ...
        expect(updatedUser.second_last_name).toStrictEqual(
          putBodyRequest.second_last_name
        );
      ...
      it("changes are reflected in db", async () => {
        ...
        expect(updatedUserFromDb.last_name).toStrictEqual(
          putBodyRequest.last_name
        );
        expect(updatedUserFromDb.second_last_name).toStrictEqual(
          putBodyRequest.second_last_name
        );
    ...
    describe("unhappy paths", () => {
      ...
      describe("403 response when", () => {
        it("trying to modify another user data", async () => {
          ...
          const response = await request
            .put(BASE_ENDPOINT + `/${otherUser.id}`)
            .send(putBodyRequest);
